...
const CheckoutPage: React.FC = () => {
  ...
  // Effect to set default form values
  useEffect(() => {
    if (loading) return; 
  ...
  if (!cart || cart.length === 0) return <CheckoutPageSkeleton />;
          ...
          <div>
            ...
            <div className="space-y-3">
               {safeSettings.codEnabled && (
                ...
                {/* CONDITIONAL RENDERING: Strictly check safeSettings.onlinePaymentEnabled */}
